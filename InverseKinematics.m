% MSE 480/780: Robotics Lab 3 - Inverse Kinematics
%
% By: Zahra Haeri & Vivek Vyas
...
alpha2_cos = cos(0);
alpha2_sin = sin(0);
A_12 = [cos(theta2+pi/2), -
1*sin(theta2+pi/2)*alpha2_cos,sin(theta2+pi/2)*alpha2_sin;sin(theta2+pi/2),
cos(theta2+pi/2)*alpha2_cos, -1*alpha2_sin*cos(theta2+pi/2);0 , alpha2_sin ,
alpha2_cos ];
11
alpha3_cos = cos(0);
alpha3_sin = sin(0);
A_23 =[cos(theta3-pi/2), -1*sin(theta3-pi/2)*cos(alpha3_cos), sin(theta3-
pi/2)*alpha3_sin;sin(theta3-pi/2), cos(theta3-pi/2)*alpha3_cos, -
1*alpha3_sin*cos(theta3-pi/2);0 , alpha3_sin , alpha3_cos ];
